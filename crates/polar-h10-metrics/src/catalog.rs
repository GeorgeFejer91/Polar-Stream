...
pub const METRIC_CATALOG: &[MetricDefinition] = &[
    ...
    metric!(
        ...
        "+1 inhale · −1 exhale · 0 pause · −2 bad signal",
        "class",
        "Breathing",
        "Phase classifies the calibrated ACC waveform as rising, falling, nearly unchanged, or bad tracking while calibration is incomplete or input is stale. It is an experimental motion classification rather than a validated airflow or clinical signal-quality measure; movement can still obscure or reverse phases without always producing the bad-signal class.",
        "experimental classification",
        BREATH_ACC,
        BREATH_ACC_URL,
        "inhale exhale pause bad signal phase respiration classifier",
        false,
        false,
        1,
        20.0,
