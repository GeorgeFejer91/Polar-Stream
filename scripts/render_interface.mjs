...
try {
  ...
  process.stdout.write(`Validated draggable persisted desktop splitters, three-source breathing comparison, source palettes, light/dark desktop and mobile states, ${targets.length} classifier renders, and ${library.previewCount} metric previews in ${output}\n`);
} finally {
  await browser.close();
